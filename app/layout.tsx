...
export const metadata: Metadata = {
  ...
  keywords: [
    "nonprofit", "changemakers", "mentorship", "social impact", "young leaders", 
    "food security", "water access", "shelter", "health", "education", "energy"
  ],
  authors: [{ name: "TRIIBE" }],
  creator: "TRIIBE",
  publisher: "TRIIBE",
  ...
  openGraph: {
    ...
    description: 'Supporting and developing the next generation of change makers advancing food, water, shelter, health, education, or energy.',
    images: [
      {
...
export default function RootLayout({
  ...
  const jsonLd = {
    ...
    seeks: {
      ...
      description: 'We seek passionate young individuals working on solutions for food, water, shelter, health, education, or energy challenges.'
    }
  }
